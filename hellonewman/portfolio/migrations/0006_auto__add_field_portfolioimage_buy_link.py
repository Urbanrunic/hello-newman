...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortfolioImage.buy_link'
        db.add_column('portfolio_portfolioimage', 'buy_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortfolioImage.buy_link'
        db.delete_column('portfolio_portfolioimage', 'buy_link')
