...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortfolioImage.order'
        db.add_column('portfolio_portfolioimage', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortfolioImage.order'
        db.delete_column('portfolio_portfolioimage', 'order')
